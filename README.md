...
| ---- | --- | --- |
| **CSV** | `optimuskg.csv.zip` | Contains the headers and partitioned data files for each node and edge type. This is useful for bulk-importing the graph into a into a Neo4j database. |
