...
def create_pipeline(**kwargs):
    return pipeline(
        ...
        inputs={
            ...
            "silver.ctd.exposure_protein",
            "silver.ctd.exposure_exposure",
            "silver.ctd.exposure_disease",
            "silver.ctd.exposure_biological_process",
            "silver.ctd.exposure_molecular_function",
            "silver.ctd.exposure_cellular_component",
            "silver.drugbank.drug_drug",
            "silver.drugbank.drug_protein",
            "silver.ncbigene.protein_biological_process",
            "silver.ncbigene.protein_cellular_component",
            "silver.ncbigene.protein_molecular_function",
            "silver.reactome.pathway_pathway",
            "silver.reactome.pathway_protein",
            "silver.ontology.disease_disease",
            "silver.ontology.cellular_component_cellular_component",
            "silver.ontology.biological_process_biological_process",
            "silver.ontology.molecular_function_molecular_function",
