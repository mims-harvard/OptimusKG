...
protein_molecular_function_interactions_node = node(
    process_protein_molecular_function_interactions,
    inputs={
    ...
    outputs="ncbigene.protein_molecular_function_interactions",
    name="protein_molecular_function_interactions",
    tags=["silver"],
)
