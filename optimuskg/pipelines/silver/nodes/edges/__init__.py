...
from .biological_process_protein import biological_process_protein_node
from .cellular_component_cellular_component import (
    cellular_component_cellular_component_node,
)
from .cellular_component_protein import cellular_component_protein_node
...
from .molecular_function_protein import molecular_function_protein_node
