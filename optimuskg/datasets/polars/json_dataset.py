...
class JSONDataset(AbstractVersionedDataset[pl.DataFrame, pl.DataFrame]):
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        Args:
            filepath: Filepath in POSIX format to a JSON file prefixed with a protocol
                `s3://`.
                If prefix is not provided, `file` protocol (local filesystem)
                will be used.
                The prefix should be any protocol supported by ``fsspec``.
                Note: `http(s)` doesn't support versioning.
            load_args: Polars options for loading JSON files.
                Here you can find all available arguments:
                https://pola-rs.github.io/polars/py-polars/html/reference/api/polars.read_json.html
                All defaults are preserved.
            save_args: Polars options for saving JSON files.
                Here you can find all available arguments:
                https://pola-rs.github.io/polars/py-polars/html/reference/api/polars.DataFrame.write_json.html
                All defaults are preserved.
