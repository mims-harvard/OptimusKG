...
export const geneFields: SchemaField[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: "canonical_exons",
        type: "List[String]",
        description: "Canonical exon coordinates",
      },
      {
        name: "transcript_ids",
        type: "List[String]",
      ...
      {
        name: "alternative_genes",
        type: "List[String]",
        description: "Alternative gene entries at the same locus",
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          { name: "source", type: "String", description: "Source database" },
          {
            name: "term_sl",
            type: "String",
            description: "Subcellular location ontology term",
          },
          {
            name: "label_sl",
            type: "String",
            description: "Subcellular location label",
          },
        ],
      },
      {
        ...
        children: [
          {
            name: "modality",
            type: "String",
            description: "Drug modality (e.g. sm, ab, pr)",
          },
          {
            name: "id",
            type: "String",
            description: "Tractability category ID",
          },
          {
            name: "value",
            type: "Boolean",
            description: "Tractability assessment value",
          },
        ],
      },
      {
        ...
        children: [
          {
            ...
            type: "String",
            description: "Score type (e.g. lof, mis)",
          },
          { name: "score", type: "Float32", description: "Constraint score" },
          {
            name: "exp",
            type: "Float32",
            description: "Expected variant count",
          },
          { name: "obs", type: "Int32", description: "Observed variant count" },
          {
            name: "oe",
            type: "Float32",
            description: "Observed/expected ratio",
          },
          {
            name: "oe_lower",
            type: "Float32",
            description: "O/E 90% CI lower bound",
          },
          {
            name: "oe_upper",
            type: "Float32",
            description: "O/E 90% CI upper bound",
          },
          {
            name: "upper_rank",
            type: "Int32",
            description: "Upper rank (gnomAD)",
          },
          {
            name: "upper_bin",
            type: "Int32",
            description: "Upper bin (10-bin)",
          },
          {
            name: "upper_bin6",
            type: "Int32",
            description: "Upper bin (6-bin)",
          },
        ],
      },
      {
        ...
        children: [
          {
            name: "pmid",
            type: "Int64",
            description: "PubMed ID of supporting reference",
          },
          {
            name: "description",
            type: "String",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            name: "impact",
            type: "String",
            description: "Functional impact (promotes/suppresses)",
          },
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: "query_percentage_identity",
            type: "Float64",
            description: "Query % sequence identity",
          },
          {
            name: "target_percentage_identity",
            type: "Float64",
            description: "Target % sequence identity",
          },
