...
const fields: SchemaField[] = [
  {
    name: "id",
    type: "String",
    description: "Node identifier in CURIE format (e.g. HP:0001250)",
  },
  {
    name: "label",
    type: "String",
    description: "Node type abbreviation (PHE)",
  },
  {
    name: "properties",
    type: "Struct",
    ...
    children: [
      ...
      { name: "code", type: "String", description: "Primary ontology code" },
      {
        name: "type",
        type: "String",
        description: "Phenotype type classification",
      },
      {
        name: "xrefs",
        type: "List[String]",
      ...
      },
      {
        name: "parents",
        type: "List[String]",
        description: "Parent phenotype terms in the ontology hierarchy",
      },
      {
        name: "children",
        type: "List[String]",
        description: "Child phenotype terms in the ontology hierarchy",
      },
      {
        name: "ancestors",
        type: "List[String]",
