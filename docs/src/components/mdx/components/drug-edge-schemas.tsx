...
const drugDiseaseProperties = [
  {
    ...
    type: "Float64",
    description: "Highest clinical trial phase for this indication",
  },
  {
    name: "structure_id",
    type: "String",
  ...
  },
  {
    ...
    type: "String",
    description: "DrugCentral drug–disease identifier",
  },
  {
    name: "reference_ids",
    type: "List[String]",
    description: "Supporting reference identifiers",
  },
  sourcesField,
];
        ...
        [
          {
            ...
            type: "String",
            description: "Description of the drug–drug interaction",
          },
          sourcesField,
        ]
      )}
      ...
      fields={baseEdgeFields("DRG-GEN", drugGeneRelations, false, [
        {
          ...
          type: "List[String]",
          description: "Mechanism of action descriptions",
        },
        {
          name: "source_ids",
          type: "List[String]",
          description: "Source-specific interaction identifiers",
        },
        {
          name: "source_urls",
          type: "List[String]",
          description: "URLs to source evidence records",
        },
        sourcesField,
      ])}
    />
