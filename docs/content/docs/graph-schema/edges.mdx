...
export const genGenFields = baseEdgeFields("GEN-GEN", true, onlySources);
...
| `DRG-GEN` | `ACTIVATOR`, `AGONIST`, `ALLOSTERIC_ANTAGONIST`, `ANTAGONIST`, `ANTISENSE_INHIBITOR`, `BINDING_AGENT`, `BLOCKER`, `CARRIER`, `CROSS_LINKING_AGENT`, `DEGRADER`, `DISRUPTING_AGENT`, `ENZYME`, `EXOGENOUS_GENE`, `EXOGENOUS_PROTEIN`, `HYDROLYTIC_ENZYME`, `INHIBITOR`, `INVERSE_AGONIST`, `MODULATOR`, `NEGATIVE_ALLOSTERIC_MODULATOR`, `NEGATIVE_MODULATOR`, `OPENER`, `OTHER`, `PARTIAL_AGONIST`, `POSITIVE_ALLOSTERIC_MODULATOR`, `POSITIVE_MODULATOR`, `PROTEOLYTIC_ENZYME`, `RELEASING_AGENT`, `RNAI_INHIBITOR`, `STABILISER`, `SUBSTRATE`, `TARGET`, `TRANSPORTER`, `VACCINE_ANTIGEN` | 36,611 |
