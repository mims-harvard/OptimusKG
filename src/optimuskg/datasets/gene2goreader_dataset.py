"""``Gene2GoReaderDataset`` loads/saves data from/to a GAF file using an underlying
...
class Gene2GoReaderDataset(
    ...
    .. code-block:: pycon
        ...
        >>> from kedro_datasets.pandas import OWLDataset
        >>> import pandas as pd
        >>>
        >>> data = pd.DataFrame({"col1": [1, 2], "col2": [4, 5], "col3": [5, 6]})
        >>>
        >>> dataset = OWLDataset(filepath=tmp_path / "test.xml")
        >>> dataset.save(data)
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        """Creates a new instance of ``Gene2GoReaderDataset`` pointing to a concrete GAF file
        ...
        Args:
            ...
            load_args: Pandas options for loading GAF files.
